...
all_large_tiff_files = os.listdir(tiff_path)
all_large_tiff_files = [tiff_file for tiff_file in all_large_tiff_files if tiff_file[-21:]=='pansharpened_clip.tif']
print (all_large_tiff_files)

for tiff_file in all_large_tiff_files:
