...
# This includes:
# * reading result from prediction and saving those to polygons data 
...
for current_file_count, (result_tif, map_tif) in enumerate(zip(all_result_tifs, all_map_tifs)):
    ...
    mask_array_to_poly_json(bin_mask_array, result_path, this_slice, reqd_class_label=['Trees', 'Crops', 'Water'])
    print ("Written Polygons from binary mask into json for {}".format(result_tif))
